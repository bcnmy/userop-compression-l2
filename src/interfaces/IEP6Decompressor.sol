...
interface IEP6Decompressor {
    ...
    struct EP6DecompressorConfiguration {
        ...
        uint256 CALL_GAS_LIMIT_REPRESENTATION_SIZE_BYTES;
        uint256 CALL_GAS_LIMIT_MULTIPLIER;
        uint256 MAX_PRIORITY_FEE_PER_GAS_REPRESENTATION_SIZE_BYTES;
        uint256 MAX_PRIORITY_FEE_PER_GAS_MULTIPLIER;
        uint256 MAX_FEE_PER_GAS_REPRESENTATION_SIZE_BYTES;
        uint256 MAX_FEE_PER_GAS_MULTIPLIER;
        uint256 INITCODE_DECOMPRESSOR_ID_REPRESENTATION_SIZE_BYTES;
        uint256 INITICODE_LENGTH_REPRESENTATION_SIZE_BYTES;
        uint256 PMD_DECOMPRESSOR_ID_REPRESENTATION_SIZE_BYTES;
        uint256 PMD_LENGTH_REPRESENTATION_SIZE_BYTES;
        uint256 CALLDATA_DECOMPRESSOR_ID_REPRESENTATION_SIZE_BYTES;
        uint256 CALLDATA_LENGTH_REPRESENTATION_SIZE_BYTES;
        uint256 SIGNATURE_DECOMPRESSOR_ID_REPRESENTATION_SIZE_BYTES;
        uint256 SIGNATURE_LENGTH_REPRESENTATION_SIZE_BYTES;
        uint256 BUNDLE_LENGTH_REPRESENTATION_SIZE_BYTES;
    }
